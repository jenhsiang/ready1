...
function getDatatable(){	
		var jsFileName = "vue-image-crop-upload.js";
	...
	new _vue2.default({
		...
		events: {
			...
			cropUploadSuccess: function cropUploadSuccess(data, field, key) {
				$.ajax({
						url: "/controller/admin/adminuserimage.jsp",
						async: false ,
						data: {avatar : data.files.avatar1}, 
						type: "POST",
						dataType: "json",
						beforeSend: function(){
						...
						success: function(ajaxdata,textStatus,jqXHR) {
										...
										}else if(ajaxdata.result == 2){
											swal({
												type: 'error',
												html: '上傳圖片失敗，請洽工程師，謝謝。'
											})
										}else if(ajaxdata.result == 3){
											swal({
												type: 'error',
												html: '寫入資料失敗，請洽工程師，謝謝。'
											})
										}else if(ajaxdata.result == 4){
											console.log('-------- 上传成功 --------');
											console.log(data);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./node_modules/.npminstall/css-loader/0.23.1/css-loader/index.js!./node_modules/.npminstall/vue-loader/8.5.4/vue-loader/lib/style-rewriter.js!./node_modules/.npminstall/vue-loader/8.5.4/vue-loader/lib/selector.js?type=style&index=0!./upload.vue", function() {
				var newContent = require("!!./node_modules/.npminstall/css-loader/0.23.1/css-loader/index.js!./node_modules/.npminstall/vue-loader/8.5.4/vue-loader/lib/style-rewriter.js!./node_modules/.npminstall/vue-loader/8.5.4/vue-loader/lib/selector.js?type=style&index=0!./upload.vue");
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = !__webpack_require__(326) && !__webpack_require__(327)(function () {
	  return Object.defineProperty(__webpack_require__(328)('div'), 'a', { get: function get() {
	      return 7;
	    } }).a != 7;
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	// 25.1.2.1.1 %IteratorPrototype%[@@iterator]()
	__webpack_require__(321)(IteratorPrototype, __webpack_require__(351)('iterator'), function () {
	  return this;
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(346)('wks'),
	    uid = __webpack_require__(347),
	    _Symbol = __webpack_require__(317).Symbol,
	    USE_SYMBOL = typeof _Symbol == 'function';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LIBRARY = __webpack_require__(315),
	    global = __webpack_require__(317),
	    ctx = __webpack_require__(319),
	...
	var USE_NATIVE = !!function () {
	  try {
	    // correct subclassing with @@species support
	    var promise = $Promise.resolve(1),
	        FakePromise = (promise.constructor = {})[__webpack_require__(351)('species')] = function (exec) {
	      exec(empty, empty);
	    };
	    // unhandled rejections tracking support, NodeJS Promise without it fails @@species test
	    return (isNode || typeof PromiseRejectionEvent == 'function') && promise.then(empty) instanceof FakePromise;
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (!setTask || !clearTask) {
	  ...
	  // Node.js 0.8-
	  if (__webpack_require__(341)(process) == 'process') {
	    defer = function defer(id) {
	      process.nextTick(ctx(run, id, 1));
	    };
	    // Browsers with MessageChannel, includes WebWorkers
...
/***/ function(module, exports, __webpack_require__) {
	...
	var global = __webpack_require__(317),
	    ...
	    process = global.process,
	    Promise = global.Promise,
	    isNode = __webpack_require__(341)(process) == 'process';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _symbol = __webpack_require__(380);
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(310);
	__webpack_require__(354);
	module.exports = __webpack_require__(379).f('iterator');
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (!USE_NATIVE) {
	  ...
	  $GOPD.f = $getOwnPropertyDescriptor;
	  $DP.f = $defineProperty;
	  __webpack_require__(391).f = gOPNExt.f = $getOwnPropertyNames;
	  __webpack_require__(388).f = $propertyIsEnumerable;
	  __webpack_require__(387).f = $getOwnPropertySymbols;
...
/***/ function(module, exports, __webpack_require__) {
	...
	// fallback for IE11 buggy Object.getOwnPropertyNames with iframe and window
	var toIObject = __webpack_require__(339),
	    gOPN = __webpack_require__(391).f,
	    toString = {}.toString;
